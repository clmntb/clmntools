...
class ServerConnection(Connection):
    ...
    def connect(self, server, port, nickname, password=None, username=None,
                ircname=None, localaddress="", localport=0, ssl=False, ipv6=False, proxy=False):
        ...
        if not proxy:
            ...
            if ipv6:
                self.socket = socks.socksocket(socket.AF_INET6, socket.SOCK_STREAM)
            else:
...
class SimpleIRCClient:
    ...
    def connect(self, server, port, nickname, password=None, username=None,
        ...
        self.connection.connect(server, port, nickname,
                                ...
                                localaddress, localport, ssl, ipv6,self.proxy)
